...
(custom-set-variables
 ...
 '(package-selected-packages
   '(avy cargo cmake-font-lock cmake-ide company counsel-projectile dape
         deadgrep dracula-theme drag-stuff ef-themes eglot flycheck
         fsharp-mode gptel gruvbox-theme lsp-ivy lua-mode magit
         multiple-cursors nov org-modern p4 pdf-tools rust-mode sly
         smartparens snap-indent standard-themes transpose-frame)))
(custom-set-faces
